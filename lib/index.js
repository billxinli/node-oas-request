...
module.exports = function (oas) {
  ...
  const client = class {
    constructor (server, { headers = {}, params = {}, query = {}, security = {} } = {}) {
    ...
    async __request (method, url, securityRequirements, options) {
      ...
      const securityOptions = Object.assign({}, this.securityOptions, options.securityOptions)
  ...
  for (const [url, methods] of Object.entries(oas.paths)) {
    ...
    for (const [method, spec] of operational) {
      ...
      Object.defineProperty(client.prototype, spec.operationId, {
        enumerable: true,
        writable: false,
        value: function ({ headers, params, query, body, security } = {}) {
